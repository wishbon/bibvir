...
<ul class="documentos movil">
	<li>
		<a href="?modulo=fichadoc&id=<?php echo $row['archivo_id']; ?>">
			<img src="./incluidos/imagenes/f_m.png" style="background-image:url('http://srv2.cpanelhost.cl/~cl119365/subidos/<?php echo $row['archivo_nombre']; ?>')" alt="" title="" class="miniatura">
		</a>
	</li>
</ul>